...
A graphical application demonstrating different concurrency approaches in Python.

## Tasks:
1. Study app.py
2. Change backend in frontend to have what app.py has and 
3. what start.py had before, function_5 is for the end (combination of all approaches).
4. Continue with project_requirements.md


## Prompt:
i want to make an app to demonstrate usage of multiprocessing, multithreading and asyncio in python. I have the project_requirements.md: `# Project: Concurrent and Parallel Programming in Python
...
`.
I will ask you questions about my project and you will answer and we will proceed step by step and dont tell me what to do next until i ask you to.
First question: inside this file I am planning to adjust to my requirements: `from nicegui import ui
import time
import asyncio
import threading
...
`, I have 3 task functions in the beginning. Can they be improved, but still keeping them simple, for the sake of my requirements which i will implement in the future.